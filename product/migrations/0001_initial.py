# Generated by Django 2.0.13 on 2019-09-17 16:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.CharField(blank=True, help_text='images must have a white background', max_length=2000, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Errors',
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('orderReferenceNumber', models.CharField(blank=True, max_length=500, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(blank=True, default='UNPUBLISHED', max_length=500, null=True)),
                ...
                ('cover_image', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
                ('image1_url', models.CharField(blank=True, help_text='Photo must have a white background', max_length=2000, null=True)),
                ('image1', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
                ('image2_url', models.CharField(blank=True, help_text='Photo must have a white background', max_length=2000, null=True)),
                ('image2', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
                ('image3_url', models.CharField(blank=True, help_text='Photo must have a white background', max_length=2000, null=True)),
                ('image3', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
                ('image4_url', models.CharField(blank=True, help_text='Photo must have a white background', max_length=2000, null=True)),
                ('image4', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
                ('image5_url', models.CharField(blank=True, help_text='Photo must have a white background', max_length=2000, null=True)),
                ('image5', models.ImageField(blank=True, help_text='Optional: If you want to upload a new image. This will replace the image in the URL provided when bulk upload is performed.', null=True, upload_to='original_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_sale_price', models.DecimalField(blank=True, decimal_places=2, max_digits=100, null=True)),
        ...
        migrations.AddField(
            model_name='sale',
            name='variation',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='product.Variations'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='orderedproduct',
            name='variation',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.Variations'),
        ),
        migrations.AddField(
            model_name='order',
            name='products',
        ...
        migrations.AddIndex(
            model_name='order',
            index=models.Index(fields=['orderReferenceNumber'], name='product_ord_orderRe_a52d87_idx'),
        ),
    ]
