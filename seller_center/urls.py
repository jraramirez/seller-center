...
urlpatterns = [
    ...
    url(r'^products/add-single-product/(?P<selected_category>.*)/(?P<product_id>.*)/$', product_views.product_import, name='product_import'),
    url(r'^products/edit/(?P<product_id>.*)/$', product_views.product_edit, name='product_edit'),
