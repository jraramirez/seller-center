...
urlpatterns = [
    ...
    url(r'^seller_admin/users', seller_admin_views.view_all_sellers),
    ...
    url(r'^orders/set_status/(?P<order_reference_number>.*)/(?P<status>.*)/$', sales_views.set_status, name='set_status'),
